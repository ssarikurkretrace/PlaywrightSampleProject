...
test('Saucelab Simple Login Test', async ({ page }) => {
    ...
    await loginPage.usernameSaucelab.fill(process.env.sauceLabsStandardUser);
    await loginPage.passwordSaucelab.fill(process.env.sauceLabsPass);

    // verify if I am in the login page
